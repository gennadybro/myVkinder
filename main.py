...
from my_token import token, group_token, token_foto
...
def username(user_id):   #  сбор информации о  пользователе
    ...
    params = {'user_ids': user_id, 'fields': 'sex,bdate,city,relation', 'access_token' : token_foto, 'v': '5.131'}
        ...
        if request == "привет":
            ...
            if wall_relation == True:
                ...
                if Vkbot.CITY == None:
                    ...
                    write_msg(user_id, f"Ваш город ,{city}, Вы {get_sex}") 
        elif request == "next":
